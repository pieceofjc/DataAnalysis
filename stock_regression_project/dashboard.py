...
# 등급 평가 함수 정의
def get_metric_grade(metric_name, value):
    if metric_name == 'RMSE':
        if value < 5:
            return "좋음", "#2e7d32"
        elif value < 10:
        ...
        if data is None or data.empty:
            ...
            if X_train is None:
                ...
                if y_pred is None:
                    ...
                    grade_rmse, color_rmse = get_metric_grade('RMSE', results['RMSE'])
                    grade_r2, color_r2 = get_metric_grade('R2', results['R2'])
                    grade_mape, color_mape = get_metric_grade('MAPE', results['MAPE'])

                    with col1:
                        st.markdown(f"<div class='metric-card' style='background-color: {color_rmse};'>", unsafe_allow_html=True)
                        ...
                        st.markdown(f"<div style='font-size: 1rem; font-weight: bold;'>등급: {grade_rmse}</div>", unsafe_allow_html=True)
                        st.markdown("</div>", unsafe_allow_html=True)

                    with col2:
                        st.markdown(f"<div class='metric-card' style='background-color: {color_r2};'>", unsafe_allow_html=True)
                        ...
                        st.markdown(f"<div style='font-size: 1rem; font-weight: bold;'>등급: {grade_r2}</div>", unsafe_allow_html=True)
                        st.markdown("</div>", unsafe_allow_html=True)

                    with col3:
                        st.markdown(f"<div class='metric-card' style='background-color: {color_mape};'>", unsafe_allow_html=True)
                        ...
                        st.markdown(f"<div style='font-size: 1rem; font-weight: bold;'>등급: {grade_mape}</div>", unsafe_allow_html=True)
                        st.markdown("</div>", unsafe_allow_html=True)
